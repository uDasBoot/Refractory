...
public class ModBlockRegistry {
    ...
    public static final RegistryObject<LiquidBlock> MOLTEN_ALUMINUM_FLUID_BLOCK = BLOCKS.register("molten_aluminum_fluid_block",
            () -> new LiquidBlock(ModFluidRegistry.SOURCE_MOLTEN_ALUMINUM_FLUID, BlockBehaviour.Properties.ofFullCopy(Blocks.LAVA)));

    public static void register(IEventBus modEventBus) {
        BLOCKS.register(modEventBus);
    }

    public static <T extends Block> RegistryObject<T> registerBlock(String name, Supplier<T> block, boolean addToTab) {
